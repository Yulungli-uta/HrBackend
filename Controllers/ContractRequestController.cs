...
public class ContractRequestController : ControllerBase
{
    ...
    public ContractRequestController(IContractRequestService svc, IMapper mapper) { _svc = svc; _mapper = mapper; }
    ...
    public async Task<IActionResult> Create([FromBody] ContractRequestCreateDto dto, CancellationToken ct)
    {
        ...
        return CreatedAtAction(nameof(GetById), new { id = idVal }, _mapper.Map<ContractRequestDto>(created));
    }
