...
[ApiController]
[Route("subrogations")]
public class SubrogationsController : ControllerBase
{
    private readonly ISubrogationsService _svc;
    private readonly IMapper _mapper;
    public SubrogationsController(ISubrogationsService svc, IMapper mapper) { _svc = svc; _mapper = mapper; }
    ...
    public async Task<IActionResult> GetById([FromRoute] int id, CancellationToken ct)
    {
        ...
        return e is null ? NotFound() : Ok(_mapper.Map<SubrogationsDto>(e));
    }
    ...
    public async Task<IActionResult> Create([FromBody] SubrogationsCreateDto dto, CancellationToken ct)
    {
        ...
        return CreatedAtAction(nameof(GetById), new { id = idVal }, _mapper.Map<SubrogationsDto>(created));
    }
