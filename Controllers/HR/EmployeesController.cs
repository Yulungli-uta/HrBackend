...
public class EmployeesController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="page">N�mero de p�gina (base 1).</param>
    /// <param name="pageSize">Cantidad de registros por p�gina. M�ximo 200.</param>
    /// <param name="search">Texto de b�squeda por nombre, apellido, c�dula o email.</param>
    /// <param name="sortBy">Campo de ordenamiento (opcional).</param>
    /// <param name="sortDirection">Direcci�n del orden: asc | desc (opcional).</param>
    [HttpGet("paged")]
    [RequirePermission("EMPLOYEES.READ")]
