...
public class AttendancePunchesController : ControllerBase
{
    ...
    /// <summary>Obtiene la �ltima marcaci�n de un empleado.</summary>
    ...
    public async Task<IActionResult> GetLastPunch([FromRoute] int employeeId, CancellationToken ct)
    {
        try
        {
            ...
            // Tomamos el primero de la lista (el �ltimo por orden de tiempo)
    ...
    /// <summary>Obtiene las marcaciones del d�a actual para un empleado.</summary>
    /// <param name="employeeId">ID del empleado</param>
