...
public class PunchJustificationsController : ControllerBase
{
    ...
    public PunchJustificationsController(IPunchJustificationsService svc, IMapper mapper) { _svc = svc; _mapper = mapper; }

    /// <summary>Lista todos los registros de PunchJustifications.</summary>
    [HttpGet]
