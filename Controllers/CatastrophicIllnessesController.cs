...
public class CatastrophicIllnessesController : ControllerBase
{
    ...
    public CatastrophicIllnessesController(ICatastrophicIllnessesService svc, IMapper mapper) { _svc = svc; _mapper = mapper; }

    /// <summary>Lista todos los registros de CatastrophicIllnesses.</summary>
    [HttpGet]
    public async Task<IActionResult> GetAll(CancellationToken ct) =>
        Ok(_mapper.Map<List<CatastrophicIllnessesDto>>(await _svc.GetAllAsync(ct)));
    ...
    public async Task<IActionResult> GetById([FromRoute] int id, CancellationToken ct)
    {
        ...
        return e is null ? NotFound() : Ok(_mapper.Map<CatastrophicIllnessesDto>(e));
    }
