...
/// <summary>
/// DTO para la actualización de una autoridad de departamento existente.
/// Permite modificar todos los campos editables del registro.
/// </summary>
public class DepartmentAuthorityUpdateDto
{
