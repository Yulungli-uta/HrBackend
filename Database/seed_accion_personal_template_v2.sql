...
BEGIN TRY
    ...
    -- Este seed es solo para catálogos UI; el renderer usa el código 'ACCION_PERSONAL'.
    IF NOT EXISTS (
    ...
    VALUES (
        ...
        'STRUCTURED_FORM',
        'PUBLISHED',
        -- HtmlContent: HTML completo de 2 páginas fiel al formato oficial UTA
        N'<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8"/>
...
<p class="mt2" style="font-size:7pt">** Si la comunicación fue electrónica se deberá colocar el medio por el cual se notificó al servidor; así como, el número del documento.</p>
    ...
    -- ── BLOQUE 8: Situación Propuesta (fuente: MANUAL) ───────────────────────
