...
IF NOT EXISTS (SELECT 1 FROM [HR].[ref_Types] WHERE [Category] = 'ADDRESS_TYPE' AND [Name] = 'Domicilio')
INSERT INTO [HR].[ref_Types] ([Category], [Name], [Description], [IsActive])
VALUES ('ADDRESS_TYPE', 'Domicilio', 'Dirección de residencia habitual', 1),
       ('ADDRESS_TYPE', 'Trabajo', 'Dirección del lugar de trabajo', 1),
       ('ADDRESS_TYPE', 'Referencia familiar', 'Dirección de un familiar de referencia', 1),
       ('ADDRESS_TYPE', 'Otro', 'Otro tipo de dirección', 1);
GO
...
CREATE TABLE [HR].[tbl_Audit] (
    ...
    [ActionDate] DATETIME2 DEFAULT (getdate()) NOT NULL,
...
-- Catalogo ref_Types requerido por tbl_BankAccounts.AccountTypeID.
IF NOT EXISTS (SELECT 1 FROM [HR].[ref_Types] WHERE [Category] = 'BANK_ACCOUNT_TYPE' AND [Name] = 'Ahorros')
INSERT INTO [HR].[ref_Types] ([Category], [Name], [Description], [IsActive])
VALUES ('BANK_ACCOUNT_TYPE', 'Ahorros', 'Cuenta de ahorros', 1),
...
CREATE TABLE [HR].[tbl_GuardShiftPlanning] (
    ...
    [AllowDoubleShift] BIT DEFAULT ((0)) NOT NULL,
    [Notes] NVARCHAR(500) NULL,
    [CreatedBy] INT NULL,
    [CreatedAt] DATETIME2 DEFAULT (getdate()) NOT NULL,
    [UpdatedBy] INT NULL,
